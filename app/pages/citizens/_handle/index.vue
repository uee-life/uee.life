...
export default {
    ...
    computed: {
        ...
        isOwner() {
            if(process.browser && this.$auth.loggedIn && this.user['https://uee.life/app_metadata'].handle.toLowerCase() == this.citizen.info.handle.toLowerCase() && this.user['https://uee.life/app_metadata'].handle_verified) {
                return true
            }
            return false
        }
